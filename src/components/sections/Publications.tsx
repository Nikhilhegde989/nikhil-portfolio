        ...
        >
          <div className="flex items-start gap-5">
            ...
            <div className="w-10 h-10 rounded-lg bg-slate-800 border border-slate-700 flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-500/10 group-hover:border-emerald-500/30 transition-colors">
              <span className="text-slate-400 font-mono font-bold text-sm group-hover:text-emerald-400 transition-colors">
                0{idx + 1}
              </span>
            </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-sm text-slate-300 hover:text-emerald-400 transition-colors group/link"
              >
