      ...
      <div className="lg:col-span-3 space-y-6">
        <div className="prose prose-slate max-w-none">
          <p className="text-lg text-slate-700 leading-relaxed">
            ...
            first with <span className="text-emerald-700 font-medium">Physics and Mathematics</span>,
          ...
          <p className="text-lg text-slate-700 leading-relaxed">
            Today, I work at the intersection of <span className="text-emerald-700 font-medium">backend architecture
          ...
          <div className="space-y-6">
            <div className="flex gap-4 group">
              ...
              <div className="pb-6">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  <span className="text-emerald-700 text-sm font-medium">CGPA: 9.06</span>
            ...
            <div className="flex gap-4 group">
              ...
              <div>
                ...
                <div className="text-slate-500 text-sm">JSS Dharwad • 2019 — 2022</div>
                <div className="text-slate-700 text-sm mt-1 font-medium">Percentage: 84%</div>
              </div>
            </div>
          </div>
        </div>
